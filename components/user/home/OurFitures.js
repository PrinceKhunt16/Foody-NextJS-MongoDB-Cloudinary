export default function OurFitures() {
    return (
                ...
                <div className="row g-4">
                    <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div className="bg-white text-center h-100 p-4 p-xl-5">
                            <img className="img-fluid mb-4" src="user/images/static/icon-1.png" alt="" />
                    ...
                    <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div className="bg-white text-center h-100 p-4 p-xl-5">
                            <img className="img-fluid mb-4" src="user/images/static/icon-2.png" alt="" />
                    ...
                    <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div className="bg-white text-center h-100 p-4 p-xl-5">
                            <img className="img-fluid mb-4" src="user/images/static/icon-3.png" alt="" />
