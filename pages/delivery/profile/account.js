...
export default function Account() {
    ...
    const handleLogout = async () => {
        await fetch(`${process.env.API_BASE_URL}/delivery/logout`, {
            method: 'DELETE'
        })
    ...
    const handleSubmitChangePassword = async () => {
        ...
        try {
            const passwordResponse = await fetch(`${process.env.API_BASE_URL}/delivery/profile/password`, {
                method: 'PUT',
    ...
    const handleSubmitChangeAvatar = async () => {
        ...
        try {
            const avatarResponse = await fetch(`${process.env.API_BASE_URL}/delivery/profile/avatar`, {
                method: 'PUT',
    ...
    const handleSubmitChangeProfile = async () => {
        ...
        try {
            const detailsResponse = await fetch(`${process.env.API_BASE_URL}/delivery/profile/me`, {
                method: 'PUT',
    ...
    const fetchMe = async () => {
        try {
            const meResponse = await fetch(`${process.env.API_BASE_URL}/delivery/profile/me`, {
                method: 'GET'
            })
