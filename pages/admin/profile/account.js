...
export default function Account() {
    ...
    const handleSubmitChangePassword = async () => {
        ...
        try {
            const passwordResponse = await fetch(`${process.env.API_BASE_URL}/admin/profile/password`, {
                method: 'PUT',
    ...
    const handleSubmitChangeAvatar = async () => {
        ...
        try {
            const avatarResponse = await fetch(`${process.env.API_BASE_URL}/admin/profile/avatar`, {
                method: 'PUT',
    ...
    const handleSubmitChangeProfile = async () => {
        ...
        try {
            const detailsResponse = await fetch(`${process.env.API_BASE_URL}/admin/profile/me`, {
                method: 'PUT',
                ...
                <div className="row g-0 gx-5 align-items-end">
                    <div className="col-lg-6">
                        <div className="section-header text-start mb-5 wow fadeInUp" data-wow-delay="0.1s">
                            <h1 className="display-5 mb-3">Account</h1>
                        </div>
                    </div>
                </div>
